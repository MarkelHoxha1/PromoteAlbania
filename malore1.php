...
<nav class="navbar navbar-default navbar-fixed-top col-lg-12">
  <div class="container-fluid">
    ...
    <script >
      function redirect()
      {
        location.href="malore1.php?search="+document.getElementById("src").value;
      }
    </script>
      <!-- Modal content-->
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
           ...
           // $paketaiID = $cat_query['paketaiID'];
            ...
            do
            {  ?>
            <a href="malore1.php?paketaID=<?php echo $cat_query['paketaID']; ?>"  value ="<?php echo $cat_query['paketaID']; ?>"  class="list-group-item">
          ...
          while($search = $sql1->fetch_assoc())
           {
               ...
               ?>
                 <a href ="malore1.php?paketaID=<?php echo $search['paketaID']; ?>"  value ="<?php echo $search['paketaID']; ?>" > <?php echo $search['EmriP']?></a><br>
