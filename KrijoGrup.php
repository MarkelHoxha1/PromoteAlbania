...
<html lang="en">
  <head>
		...
		<script type="text/javascript">
 			 function kontrollRegister()
 			 {
   				 alert("Ju duhet te jeni te rregjistruar qe te bashkoheni ne kete sfide");
  ...
  <body>
		...
		if(isset($_GET['SfidaId']))
    {
        ...
        $acc_fetch = $acc_query->mysql_fetch_array();
              ?>
		<div class="container">
			...
			<div class="container-fliud">
				<div class="wrapper row">
					...
					<div class="details col-md-6">
						...
						<div class="action">
							<a class=" btn btn-primary" onclick="kontrollRegister()" type="button">Bashkohu</a>
