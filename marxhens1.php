         ...
         <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
           ...
           // $paketaiID = $cat_query['paketaiID'];
            ...
            do
            {  ?>
            <a href="marxhens1.php?paketaID=<?php echo $cat_query['paketaID']; ?>"  value ="<?php echo $cat_query['paketaID']; ?>"  class="list-group-item">
          ...
          while($search = $sql1->fetch_assoc( ))
           {
               ...
               ?>
                 <a href ="marxhens1.php?paketaID=<?php echo $search['paketaID']; ?>"  value ="<?php echo $search['paketaID']; ?>" > <?php echo $search['EmriP']?></a><br>
